...
- Refinamento local: o painel agora usa o padrão `glass.optical.overlay` (transparência em camadas, blur/saturação, aro interno, reflexo e sombra), com fallback opaco e alto contraste. O subtítulo da assinatura foi ampliado em todos os breakpoints.
